...
{
	if(self->factory)
		delete reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory);
...
Factory_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
	...
	if(self != NULL)
	{
		...
		try
		{
			self->factory = new std::shared_ptr<AUD_IFactory>(new AUD_FileFactory(filename));
		}
...
Factory_sine(PyTypeObject* type, PyObject *args)
{
	...
	if(self != NULL)
	{
		try
		{
			self->factory = new std::shared_ptr<AUD_IFactory>(new AUD_SinusFactory(frequency, (AUD_SampleRate)rate));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(self);
...
Factory_lowpass(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_LowpassFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), frequency, Q));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_delay(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_DelayFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), delay));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_join(Factory* self, PyObject *object)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_DoubleFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), *reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(child->factory)));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_highpass(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_HighpassFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), frequency, Q));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_limit(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_LimiterFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), start, end));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_pitch(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_PitchFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), factor));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_volume(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_VolumeFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), volume));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_fadein(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_FaderFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), AUD_FADE_IN, start, length));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_fadeout(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_FaderFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), AUD_FADE_OUT, start, length));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_loop(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_LoopFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), loop));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_mix(Factory* self, PyObject *object)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_SuperposeFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), *reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(child->factory)));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_pingpong(Factory* self)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_PingPongFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory)));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_reverse(Factory* self)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_ReverseFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory)));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_buffer(Factory* self)
{
	...
	if(parent != NULL)
	{
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_StreamBufferFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory)));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_square(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_SquareFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), threshold));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
Factory_filter(Factory* self, PyObject *args)
{
	...
	if(parent != NULL)
	{
		...
		try
		{
			parent->factory = new std::shared_ptr<AUD_IFactory>(new AUD_IIRFilterFactory(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(self->factory), b, a));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(parent);
...
{
	if(self->handle)
		delete reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle);
	Py_TYPE(self)->tp_free((PyObject *)self);
}
...
Handle_pause(Handle *self)
{
	try
	{
		return PyBool_FromLong((long)(*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->pause());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Handle_resume(Handle *self)
{
	try
	{
		return PyBool_FromLong((long)(*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->resume());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Handle_stop(Handle *self)
{
	try
	{
		return PyBool_FromLong((long)(*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->stop());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Handle_get_position(Handle *self, void* nothing)
{
	try
	{
		return Py_BuildValue("f", (*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->getPosition());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Handle_set_position(Handle *self, PyObject *args, void* nothing)
{
	...
	try
	{
		if((*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->seek(position))
			return 0;
...
Handle_get_keep(Handle *self, void* nothing)
{
	try
	{
		return PyBool_FromLong((long)(*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->getKeep());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Handle_set_keep(Handle *self, PyObject *args, void* nothing)
{
	...
	try
	{
		if((*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->setKeep(keep))
			return 0;
...
Handle_get_status(Handle *self, void* nothing)
{
	try
	{
		return PyBool_FromLong((long)(*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->getStatus());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Handle_get_volume(Handle *self, void* nothing)
{
	try
	{
		return Py_BuildValue("f", (*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->getVolume());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Handle_set_volume(Handle *self, PyObject *args, void* nothing)
{
	...
	try
	{
		if((*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->setVolume(volume))
			return 0;
...
Handle_get_pitch(Handle *self, void* nothing)
{
	try
	{
		return Py_BuildValue("f", (*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->getPitch());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Handle_set_pitch(Handle *self, PyObject *args, void* nothing)
{
	...
	try
	{
		if((*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->setPitch(pitch))
			return 0;
...
Handle_get_loop_count(Handle *self, void* nothing)
{
	try
	{
		return Py_BuildValue("i", (*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->getLoopCount());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Handle_set_loop_count(Handle *self, PyObject *args, void* nothing)
{
	...
	try
	{
		if((*reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle))->setLoopCount(loops))
			return 0;
...
Handle_get_location(Handle *self, void* nothing)
{
	try
	{
		AUD_I3DHandle* handle = dynamic_cast<AUD_I3DHandle*>(reinterpret_cast<std::shared_ptr<AUD_IHandle>*>(self->handle)->get());
		if(handle)
		{
...
{
	if(self->device)
		delete reinterpret_cast<std::shared_ptr<AUD_IDevice>*>(self->device);
	Py_TYPE(self)->tp_free((PyObject *)self);
}
	...
	if(self != NULL)
	{
		...
		try
		{
			...
			case AUD_DEVICE_NULL:
				...
				self->device = new std::shared_ptr<AUD_IDevice>(new AUD_NULLDevice());
				break;
			case AUD_DEVICE_OPENAL:
#ifdef WITH_OPENAL
				self->device = new std::shared_ptr<AUD_IDevice>(new AUD_OpenALDevice(specs, buffersize));
#endif
				break;
			case AUD_DEVICE_SDL:
#ifdef WITH_SDL
				self->device = new std::shared_ptr<AUD_IDevice>(new AUD_SDLDevice(specs, buffersize));
#endif
				break;
			case AUD_DEVICE_JACK:
#ifdef WITH_JACK
				self->device = new std::shared_ptr<AUD_IDevice>(new AUD_JackDevice(name, specs, buffersize));
#endif
				break;
...
Device_play(Device *self, PyObject *args, PyObject *kwds)
{
	...
	if(handle != NULL)
	{
		try
		{
			handle->handle = new std::shared_ptr<AUD_IHandle>((*reinterpret_cast<std::shared_ptr<AUD_IDevice>*>(self->device))->play(*reinterpret_cast<std::shared_ptr<AUD_IFactory>*>(sound->factory), keep));
		}
		catch(AUD_Exception& e)
		{
			Py_DECREF(handle);
...
Device_stopAll(Device *self)
{
	try
	{
		(*reinterpret_cast<std::shared_ptr<AUD_IDevice>*>(self->device))->stopAll();
		Py_RETURN_NONE;
	}
	catch(AUD_Exception& e)
	{
...
Device_lock(Device *self)
{
	try
	{
		(*reinterpret_cast<std::shared_ptr<AUD_IDevice>*>(self->device))->lock();
		Py_RETURN_NONE;
	}
	catch(AUD_Exception& e)
	{
...
Device_unlock(Device *self)
{
	try
	{
		(*reinterpret_cast<std::shared_ptr<AUD_IDevice>*>(self->device))->unlock();
		Py_RETURN_NONE;
	}
	catch(AUD_Exception& e)
	{
...
Device_get_rate(Device *self, void* nothing)
{
	try
	{
		AUD_DeviceSpecs specs = (*reinterpret_cast<std::shared_ptr<AUD_IDevice>*>(self->device))->getSpecs();
...
Device_get_volume(Device *self, void* nothing)
{
	try
	{
		return Py_BuildValue("f", (*reinterpret_cast<std::shared_ptr<AUD_IDevice>*>(self->device))->getVolume());
	}
	catch(AUD_Exception& e)
	{
		PyErr_SetString(AUDError, e.str);
...
Device_set_volume(Device *self, PyObject *args, void* nothing)
{
	...
	try
	{
		(*reinterpret_cast<std::shared_ptr<AUD_IDevice>*>(self->device))->setVolume(volume);
		return 0;
	}
	catch(AUD_Exception& e)
	{
...
Device_get_listener_location(Device *self, void* nothing)
{
	try
	{
		AUD_I3DDevice* device = dynamic_cast<AUD_I3DDevice*>(reinterpret_cast<std::shared_ptr<AUD_IDevice>*>(self->device)->get());
		if(device)
		{
