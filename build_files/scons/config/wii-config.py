...
WITH_BF_SDL = True
BF_SDL = '/opt/devkitpro/portlibs/wii' #$(shell sdl-config --prefix)
...
WITH_BF_PNG = True
BF_PNG = '/opt/devkitpro/portlibs/ppc'
BF_PNG_INC = '${BF_PNG}/include'
BF_PNG_LIB = 'png'

WITH_BF_TIFF = False
BF_TIFF = '/opt/devkitpro'
BF_TIFF_INC = '${BF_TIFF}/include'
BF_TIFF_LIB = 'tiff'

WITH_BF_ZLIB = True
BF_ZLIB = '/opt/devkitpro/portlibs/ppc'
...
BF_PCRE = ''
BF_PCRE_LIB = 'pcre'
BF_PCRE_LIBPATH = '/opt/devkitpro/lib'
BF_EXPAT = '/opt/devkitpro'
BF_EXPAT_LIB = 'expat'
BF_EXPAT_LIBPATH = '/opt/devkitpro/lib'

WITH_BF_JEMALLOC = False
WITH_BF_STATICJEMALLOC = False
BF_JEMALLOC = '/opt/devkitpro'
...
BF_CYCLES_CUDA_NVCC = '/opt/devkitpro/local/cuda/bin/nvcc'
...
PLATFORM_LINKFLAGS = ['-mrvl', '-L/opt/devkitpro/portlibs/wii/lib', '-L/opt/devkitpro/portlibs/ppc/lib', '-L/opt/devkitpro/libogc/lib/wii']
