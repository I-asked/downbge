...
BF_CXX = DEVKITPRO+'/devkitARM/arm-none-eabi'
...
BF_SNDFILE = DEVKITPRO+'/portlibs/3ds'
BF_SNDFILE_INC = '${BF_SNDFILE}/include/sndfile'
BF_SNDFILE_LIB = 'sndfile mpg123'
BF_SNDFILE_LIBPATH = '${BF_SNDFILE}/lib'

WITH_BF_SDL = True
WITH_GHOST_SDL = True
BF_SDL = DEVKITPRO+'/portlibs/3ds' #$(shell sdl-config --prefix)
BF_SDL_INC = '${BF_SDL}/include/SDL2' #$(shell $(BF_SDL)/bin/sdl-config --cflags)
BF_SDL_LIB = 'SDL2 GLU GL EGL ctru'
...
WITH_BF_JPEG = True
BF_JPEG = DEVKITPRO+'/portlibs/3ds'
BF_JPEG_INC = '${BF_JPEG}/include'
BF_JPEG_LIB = 'jpeg'

WITH_BF_PNG = True
BF_PNG = DEVKITPRO+'/portlibs/3ds'
...
WITH_BF_ZLIB = True
BF_ZLIB = DEVKITPRO+'/portlibs/3ds'
...
BF_FREETYPE = DEVKITPRO+'/portlibs/3ds'
...
WITH_BF_OGG = True
BF_OGG = DEVKITPRO+'/portslibs/arm'
...
BF_OPENGL = DEVKITPRO+'/portlibs/3ds'
BF_OPENGL_INC = '${BF_OPENGL}/include'
BF_OPENGL_LIB = BF_SDL_LIB
BF_OPENGL_LIBPATH = DEVKITPRO+'/portlibs/3ds/lib'
...
ARCHFLAGS = '-march=armv6k -mtune=mpcore -mfloat-abi=hard -mtp=soft'.split()
ARCHDEFS = '-D__3DS__ -D_3DS -DARM11'.split()
CCFLAGS = ARCHFLAGS+ARCHDEFS+['-pipe','-funsigned-char','-fno-strict-aliasing', '-D_LARGEFILE_SOURCE', '-D_FILE_OFFSET_BITS=64','-D_LARGEFILE64_SOURCE', '-I'+DEVKITPRO+'/libctru/include', '-I'+DEVKITPRO+'/portlibs/3ds/include', '-I'+DEVKITPRO+'/devkitARM/arm-none-eabi/include']
CFLAGS = ['-std=gnu89']
CXXFLAGS = []
...
LLIBS = ['util', 'bz2', 'm']
LINKFLAGS = ARCHFLAGS+['-L'+DEVKITPRO+'/portlibs/3ds/lib', '-L'+DEVKITPRO+'/libctru/lib', '-L'+DEVKITPRO+'/devkitARM/arm-none-eabi/lib/armv6k/fpu', '-specs=3dsx.specs']
...
BF_BUILDDIR = '../build/3ds'
BF_INSTALLDIR='../install/3ds'

PLATFORM_LINKFLAGS = LINKFLAGS
